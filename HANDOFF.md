...
Каркас в **`apps/mobile`** (автономно от монорепо). MVP: Главная → Каталог →
Товар → Корзина, на русском, поверх того же Store API. Подробности и запуск —
...
- Дальше (этапы 3–6): нативный чекаут (ЮKassa через WebBrowser), личный кабинет,
  push, иконка/сплэш, сборка и публикация через EAS.
- Стор-аккаунты (Apple $99/год, Google $25) — на владельце.
